...
women_with_stable_mental_health <- subset(diabetes_csv, 
...
men_with_stable_mental_health <- subset(diabetes_csv, 
                                        diabetes_csv$MentHlth == 0 &
                                        diabetes_csv$Sex == 1)

#Men with more or equal than 10 days feeling not good with their mental health
men_with_mental_health_problems_more_than_10_days_a_month <- subset(diabetes_csv,
                                                                  diabetes_csv$MentHlth == 0 &
                                                                  diabetes_csv$Sex == 1)
