...
p1 <- ggplot(summary_women_stable_mental_health, aes(x = Income, y = BMI)) +
  geom_point() +
  geom_smooth(method = "lm", se = FALSE, color = "blue", linetype = "solid", size = 1.0) +
  labs(title = "Stable Mental Health", x = "Income", y = "BMI")

# Create the second ggplot
p2 <- ggplot(summary_women_mental_health_problems_10days, aes(x = Income, y = BMI)) +
  geom_point() +
  geom_smooth(method = "lm", se = FALSE, color = "red", linetype = "solid", size = 1.0) +
  labs(title = "Mental Health Problems", x = "Income", y = "BMI")

# Use ggarrange to combine the two plots
ggarrange(p1, p2, ncol = 2, align = "h",
          common.legend = TRUE, legend = "bottom")

ggplot(summary_women_stable_mental_health, aes(x = Income, y = BMI)) +
  geom_point() +
  geom_smooth(method = "lm", se = FALSE)

ggplot(summary_women_mental_health_problems_10days, aes(x = Income, y = BMI)) +
  geom_point() +
  geom_smooth(method = "lm", se = FALSE)

lm_stable_mental_health <- lm(BMI ~ Income, data = summary_women_stable_mental_health)
lm_mental_health_problems_10days <- lm(BMI ~ Income, data = summary_women_mental_health_problems_10days)

ggplot(summary_women_stable_mental_health, aes(x = Income, y = BMI)) +
  geom_point() +
  geom_smooth(method = "lm", se = FALSE, 
              formula = lm_stable_mental_health, 
              color = "blue", linetype = "solid", 
              size = 1.5, 
              show.legend = TRUE, 
              aes(label = "Stable Mental Health")) +
  geom_smooth(data = summary_women_mental_health_problems_10days, 
              method = "lm", se = FALSE, 
              formula = lm_mental_health_problems_10days, 
              color = "red", linetype = "dashed", 
              size = 1.5, 
              show.legend = TRUE, 
              aes(label = "Mental Health Problems")) +
  theme(legend.position = "bottom")
```

 * Cardiopathy - High Colesterol
