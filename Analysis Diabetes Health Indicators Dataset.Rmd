...
En cuanto a la predicción sobre si un dindividuo desarrollará diabetes, hemos con¿Pueden las preguntas de encuesta del BRFSS proporcionar predicciones precisas 
de si un individuo tiene diabetes?

Está bien estudiado que la diabetes tipo II está asociada con
niveles más altos de BMI juega un factor importante.

## Preguntas propuestas en el sitio web ([KAGGLE](https://www.kaggle.com/datasets/alexteboul/diabetes-health-indicators-dataset)) 

 * ¿Pueden las preguntas de encuesta del BRFSS proporcionar predicciones precisas de si un individuo tiene diabetes?

([BMI alto está asociado a la diabetes](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4259868/))

Por lo tanto nos hemos hecho una pregunta: Sería posible que el la salud mental, salario, 
y la diabetes estén asociados a un BMI más alto? 
...
Hemos hecho varias observaciones y es que también la variable Income influye sobre la cantidad de ejercicio físico
...
Por lo tanto, nos hemos hecho una pregunta: 
